...
{
    public class Sterling_Command_MeshProcessor : BaseMeshProcessor
    {
        public Sterling_Command_MeshProcessor(ApplicationContext appContext)
            : base(appContext)
        {
        }

        public override Guid GetProviderId() =>
          SterlingConstants.ProviderId;
