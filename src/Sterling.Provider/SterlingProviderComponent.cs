...
using CluedIn.Crawling.Sterling.Infrastructure.Installers;
// 
using ComponentHost;
...
{
    [Component(SterlingConstants.ProviderName, "Providers", ComponentType.Service, ServerComponents.ProviderWebApi, Components.Server, Components.DataStores, Isolation = ComponentIsolation.NotIsolated)]
    public sealed class SterlingProviderComponent : ServiceApplicationComponent<IBusServer>
    {
        public SterlingProviderComponent(ComponentInfo componentInfo)
            : base(componentInfo)
        {
            // Dev. Note: Potential for compiler warning here ... CA2214: Do not call overridable methods in constructors
            //   this class has been sealed to prevent the CA2214 waring being raised by the compiler
            Container.Register(Component.For<SterlingProviderComponent>().Instance(this));
        }
