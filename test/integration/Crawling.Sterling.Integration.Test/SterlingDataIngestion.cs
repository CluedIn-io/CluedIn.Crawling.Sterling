...
{
    public class DataIngestion : IClassFixture<SterlingTestFixture>
    {
        private readonly SterlingTestFixture fixture;
        private readonly ITestOutputHelper output;

        public DataIngestion(SterlingTestFixture fixture, ITestOutputHelper output)
        {
